...
public class MotorboatItem extends Item {
    ...
    public void appendHoverText(@Nonnull ItemStack itemStack, @Nonnull TooltipContext context, @Nonnull TooltipDisplay display, @Nonnull Consumer<Component> builder, @Nonnull TooltipFlag tooltipFlag) {
        builder.accept(Component.translatable("tooltip.cargoboats.motorboat.base_energy", Config.MOTORBOAT_BASE_ENERGY_USAGE.getAsInt())
                .withStyle(ChatFormatting.AQUA));
        if (itemStack.getOrDefault(CargoBoats.MOTORBOAT_HAS_DATA, false)) {
            builder.accept(Component.translatable("tooltip.cargoboats.motorboat.has_data").withStyle(ChatFormatting.YELLOW));
        }
    }
